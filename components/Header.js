...
export class Header extends React.Component {
  ...
  render() {
    return <header>
      ...
      <Menu isOpen={this.state.isMenuOpen} toggleMenu={this.toggleMenu} />

      <div className="header-menu-toggle" onClick={this.toggleMenu}>
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 294.843 294.843">
          <g>
